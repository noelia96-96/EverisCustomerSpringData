...
public class EverisCustomerSpringDataMain implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(EverisCustomerSpringDataMain.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		// ELIMINAR
		// everisCustomerService.removeCustomer(customer4);
